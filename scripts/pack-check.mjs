...
// every published artifact by the MiKode licensing standard. The CLI entry point is
// committed JavaScript rather than build output, so it is listed rather than derived.
const expected = new Set([
	...emitted,
	'bin/mikode-git-hooks.mjs',
	'LICENSE',
	'package.json',
	'README.md',
]);
